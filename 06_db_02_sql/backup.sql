...
COPY public.clients (id, lastname, country, orderref) FROM stdin;
...
--
-- Name: country; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX country ON public.clients USING btree (country);


--
-- Name: clients clients_orderref_fkey; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.clients
    ADD CONSTRAINT clients_orderref_fkey FOREIGN KEY (orderref) REFERENCES public.orders(id);
